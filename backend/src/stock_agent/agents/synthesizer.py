...
from stock_agent.infra.llm.provider import DeepLLMProxy, FastLLMProxy
from stock_agent.monitoring.logger import logger

class SynthesizerAgent:
    def __init__(self, repository: DataRepository, llm_client: LLMClient = None):
        self.repository = repository
        self.llm_client = llm_client or DeepLLMProxy()
        self.technical_analyst = TechnicalAnalyst(repository)
        self.fundamental_analyst = FundamentalAnalyst()
        self.news_analyst = NewsAnalyst(FastLLMProxy())
